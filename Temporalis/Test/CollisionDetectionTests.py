...
class CollisionDetectionTests(unittest.TestCase):
    ...
    def test_collide_rect_test(self):
        ...
        obj1 = GameObject(100, 100, 20, 20)
        obj2 = GameObject(110, 100, 20, 20)
